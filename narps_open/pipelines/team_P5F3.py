...
""" Write the work of NARPS team P5F3 using Nipype """
...
class PipelineTeamP5F3(Pipeline):
    """ A class that defines the pipeline of team P5F3 """
...
Instead, we corrected for slice time effects by adding temporal derivatives of our task regressors to our first-level (within run) statistical model (GLM).
        ...
        motion_correction.inputs.dof = 6
